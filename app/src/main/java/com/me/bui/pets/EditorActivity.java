...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>{
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            int nameColIdx = cursor.getColumnIndex(PetEntry.COLUMN_PET_NAME);
            int breedColIdx = cursor.getColumnIndex(PetEntry.COLUMN_PET_BREED);
            int genderColIdx = cursor.getColumnIndex(PetEntry.COLUMN_PET_GENDER);
            int weightColIdx = cursor.getColumnIndex(PetEntry.COLUMN_PET_WEIGHT);

            // Extract out the value from the Cursor for the given column index
            String name = cursor.getString(nameColIdx);
            String breed = cursor.getString(breedColIdx);
            int gender = cursor.getInt(genderColIdx);
            int weight = cursor.getInt(weightColIdx);
    ...
    public void onLoaderReset(Loader<Cursor> loader) {
        ...
        mGenderSpinner.setSelection(0); // Select "Unknown" gender PetEntry.GENDER_UNKNOWN
    }
}